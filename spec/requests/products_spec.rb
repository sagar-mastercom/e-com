...
RSpec.describe "/products", type: :request do
  ...
  let(:valid_attributes) {
    FactoryBot.attributes_for(:Product, name: Faker::Commerce.product_name, price: Faker::Commerce.price)
  }
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested product" do
        ...
        # expect(response.body).to include("Product successfully updated")
      end
